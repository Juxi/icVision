...
allParts    = [KEY_HEAD,  KEY_TORSO, KEY_LEFT_ARM, KEY_RIGHT_ARM]
resetParts  = [KEY_RIGHT_ARM] # parts used in reset function
actionParts = [KEY_RIGHT_ARM]
sensorParts = [KEY_RIGHT_ARM]
...
class iCubEnvironment(Environment, Named):
    ...
    def __init__(self, remote_port):
        ...
        for ipart in allParts:
            ...
            options.put("local", "/iCubInteractor/" + partNames[ipart])
