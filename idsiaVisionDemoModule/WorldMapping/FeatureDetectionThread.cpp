...
FeatureDetectionThread::FeatureDetectionThread(int *threshold) {
    thresholdValue = threshold;
}


FeatureDetectionThread::~FeatureDetectionThread() {
	// TODO Auto-generated destructor stub
}


bool FeatureDetectionThread::threadInit() {
    /*
...
void FeatureDetectionThread::run() {
    /*
    * do some work ....
...
void FeatureDetectionThread::threadRelease() {
   /* for example, delete dynamically created data-structures */
}

void FeatureDetectionThread::onStop() {
