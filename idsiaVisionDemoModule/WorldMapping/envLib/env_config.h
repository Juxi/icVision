...
#ifndef ENVISION_ENV_CONFIG_H_DEFINED
#define ENVISION_ENV_CONFIG_H_DEFINED

#define ENV_WITH_DYNAMIC_CHANNELS

#define ENV_WITH_VISIT_CHANNEL
...
#else
// just leave ENV_INTG64_TYPE undefined and we'll get along without a
// 64-bit type
#endif
...
#endif // ENVISION_ENV_CONFIG_H_DEFINED
