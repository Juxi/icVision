...
#define env_img_initializer { {0,0}, 0 } //REV: Oh! this is initializing the above. It makes dims (0,0) and the 
//pixels pointer "pixels" point to zero (i.e. null?)
...
extern "C"
{
        ...
        static inline intg32* env_img_pixelsw(struct env_image* img); //REV: this just returns the pixels ptr
        //(i.e. beginning of data array) of the rgb img...
