...
class GaborFilter {
	...
	public:
		...
		void setParam(unsigned int L/*=5*/, unsigned int D/*=8*/, float f/*=1.0/sqrt(2.0)*/, float kmax/*=1.7*/, float sigma/*=2*3.1416*/, float N/*=1.0*/);
...
/*		COMPUTE GABORFILTER	*/
		...
		std::vector<int> mvec_filtersize_filter;
