...
#ifndef FEATUREDETECTIONTHREAD_H_
#define FEATUREDETECTIONTHREAD_H_
...
class FeatureDetectionThread: public yarp::os::Thread {
...
public:
	...
	*/
	FeatureDetectionThread(int *threshold);

	/**
	* destructor.
	*/
	~FeatureDetectionThread();
...
#endif /* FEATUREDETECTIONTHREAD_H_ */
