...
public:
	...
	void setRobot( Robot* aRobot ) { robot = aRobot; }	//!< Binds this collision detector to a robot model
	void setWorld( World* aWorld ) { world = aWorld; }	//!< Binds this collision detector to a world model
