...
#include <cstdlib>
#include <iostream>
#include "redlocator_module.h"

using namespace yarp::os;
using namespace yarp::sig;

RedLocatorModule::RedLocatorModule() : isStarted (false) {
	//moduleName = "IM-CLeVeR::Vision::Reaching";
	setName("RedLocator");
}

RedLocatorModule::~RedLocatorModule() { 
}
 ...
 */
//bool RedLocatorModule::configure(yarp::os::ResourceFinder &rf)
bool RedLocatorModule::configure(yarp::os::Searchable& config)
{
...
//	}
	...
	if(! outputPort_ImagePosition.open( outputPortName.c_str() )){
		return false;
	}
...
*/
bool RedLocatorModule::updateModule()
{
...
*/
bool RedLocatorModule::respond(const yarp::os::Bottle& command, yarp::os::Bottle& reply)
{
...
* Interrupt function.
*/
bool RedLocatorModule::interruptModule()
{
...
bool RedLocatorModule::open(yarp::os::Searchable& config)
{
