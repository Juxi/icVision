 ...
 */
class VirtualSkin::WorldRpcInterface : public QThread
{
...
public:
	...
	void setModel( VirtualSkin::YarpModel* m ) { model = m; }	//!< Sets the RobotModel::World on which this interface operates
