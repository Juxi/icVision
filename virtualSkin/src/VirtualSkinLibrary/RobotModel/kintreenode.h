...
protected:
	...
	void serialFilter( KinTreeNode* node, bool link = false, bool joint = false );	//!< Recursively decends serial chains eliminating FreeSOLID collision response to collisions between 'adjacent' geometries
