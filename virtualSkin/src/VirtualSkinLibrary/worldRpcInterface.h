...
public:
	...
	void setWorld( RobotModel::World* aWorld ) { world = aWorld; }
...
private:
	...
	RobotModel::CompositeObject* getObject( const yarp::os::Bottle& cmd, yarp::os::Bottle& reply, int& n  );
	RobotModel::PrimitiveObject* getPrimitive( const RobotModel::CompositeObject* Object, const yarp::os::Bottle& cmd, yarp::os::Bottle& reply, int& n  );
