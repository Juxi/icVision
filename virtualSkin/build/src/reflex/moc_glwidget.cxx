...
static const char qt_meta_stringdata_GLWidget[] = {
    "GLWidget\0\0renderStuff()\0angle\0"
    "xRotationChanged(int)\0yRotationChanged(int)\0"
    "zRotationChanged(int)\0displayList\0"
    "addDisplayList(RobotModel::DisplayList*)\0"
    "idx\0removeDisplayList(int)\0update()\0"
